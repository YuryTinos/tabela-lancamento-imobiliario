...
function criarTabelaDeSugestoes(lancamentos, valorTotal) {
    ...
    $('#sugestoes table tbody')
        ...
        .append(valoresSumarizados.valoresAnuais.map((s, i, arr) => {
            ...
            const valorMensalidade = calcularMensalidade(s, valoresExtras, valorTotal, lancamentos.length, false);

            return `<tr>
                <th scope="row">${s.ano} (x${s.qtdParcelas})</th>
                <td class="text-left">
                <!-- <div class="form-check">
                    <!-- <span data-toggle="tooltip" data-placement="top" title="Remover investimento de Parcela Única e Registro deste ano?">
                            <!-- <input class="form-check-input" type="checkbox" value="" id="defaultCheck${i}"> -->
                            <!-- <label class="form-check-label" for="defaultCheck${i}"><u> -->
